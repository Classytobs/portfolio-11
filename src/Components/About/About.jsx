                ...
                <div>
                  ...
                  <div>
                      <div className='flex flex-row cursor-pointer justify-start space-x-11 mt-4'>
                        <a href="https://twitter.com/engr_tobs" target="blank"> <img src={twitter} alt='twitter' className='w-8 h-8 rounded-full transition ease-in-out delay-150 md:hover:-translate-y-1 md:hover:scale-110 duration-300' /></a>
                        <a href="https://linkedin.com/in/oluwatobi-adewumi-879548213" target="blank"><img src={linkedin} alt='linkedin' className='w-8 h-8 rounded-lg transition ease-in-out delay-150 md:hover:-translate-y-1 md:hover:scale-110 duration-300' /></a>
                        <a href="https://github.com/Classytobs" target="blank"> <img src={github} alt='github' className='w-8 h-8 rounded-full  transition ease-in-out delay-150 md:hover:-translate-y-1 md:hover:scale-110 duration-300' /></a>
                      </div>
                  </div>
              </div>
