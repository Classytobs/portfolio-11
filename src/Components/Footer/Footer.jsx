...
export default function Footer() {
  return (
    <div className='flex flex-col bg-gray-500 hover:bg-gray-600 min-h-32 gap-y-5 px-16 py-10 text-2xl max-w-full content-center justify-between items-center font-serif text-white'>
        <div>
            <a href="#">Classytobs</a>
        </div>
