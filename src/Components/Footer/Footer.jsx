...
export default function Footer() {
  ...
  return (
    <div className={theme? 'flex flex-col w-full justify-between items-center content-center px-32 gap-y-8 py-5 bg-slate-200 text-dark font-serif':
    'flex flex-col w-full justify-between items-center bg-slate-900 gap-y-8 content-center px-32 py-5 font-serif text-white'}>
