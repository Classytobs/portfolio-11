...
export default function Home() {
  ...
  return (
    <div className=' flex flex-col bg-zinc-900 gap-y-6 justify-evenly content-center py-8 min-h-screen max-w-full items-center'>
      ...
      <div className='flex flex-col justify-between content-center items-center gap-y-3'>
            ...
            transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 mb-3'>
              <img src={img0} alt='me'className='h-56 w-56 rounded-full '/>
            </div>
