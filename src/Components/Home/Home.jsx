...
export default function Home() {
  ...
  return (
    <div id='home' className={theme? 'flex flex-col z-0 text-white bg-zinc-900 gap-y-6 justify-center content-center pt-8 min-h-screen max-w-full items-center':
     'flex flex-col z-0 text-black gap-y-6 justify-start content-center py-8 min-h-screen max-w-full items-center'}>
      <div className='p-2 cursor-pointer mt-24' onClick={changeTheme} >
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" /></svg>
      </div> 
      <div className='flex flex-col justify-between content-center items-center gap-y-5'>
