...
export default function Home() {
  ...
  return (
    <div id='home' className={theme? 'flex flex-col text-white bg-zinc-900 gap-y-6 justify-start content-center py-8 min-h-screen max-w-full items-center': 'flex flex-col text-black gap-y-6 justify-start content-center py-8 min-h-screen max-w-full items-center'}>
