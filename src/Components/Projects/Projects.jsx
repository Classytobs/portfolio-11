  ...
  return (
    ...
    'flex flex-col bg-slate-900 text-white min-h-screen px-6 md:px-16 lg:px-32 gap-y-8 py-16 font-serif'}>
              ...
              <div >
                ...
                <h2 className='text-2xl'>Every project is unique and these are some of the recent ones</h2>
              </div>
                ...
                <div className='text-4xl font-bold'>Todo list app</div>
                  <div><h1 className='text-2xl leading-relaxed'>In a world characterized by constant demands and a myriad of
