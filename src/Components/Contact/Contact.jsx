    ...
    <div className='flex flex-col bg-zinc-900 gap-y-8 min-h-screen px-16 py-16 max-w-full justify-between content-center items-center font-serif text-white'>
        ...
        <div className='flex flex-col gap-y-8 justify-between content-center items-center'>
            ...
            <div className='flex flex-col content-center gap-y-4'>
                ...
                <div className=" flex flex-col cursor-pointer justify-between content-center items-center gap-y-4 rounded-lg bg-slate-500 hover:bg-slate-600 shadow-md border-solid border-2 border-indigo-600 p-5 ">
                        <div>
                    ...
                    <div>
                        ...
                        <div class="mb-3">
                            <button
                            type="submit"
                            className='bg-blue-700 shadow-md h-fit px-2 py-2 rounded-lg hover:bg-blue-500'
                            >
                            Contact me
                            </button>
                        </div>
